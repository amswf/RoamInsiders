...
const privacyEn: LegalDocument = {
  ...
  sections: [
    ...
    { heading: "2. Location entries", paragraphs: ["When you press a flight button on an article page, the site asks your browser for precise location permission solely to select the nearest departure airport from the site's scheduled-service airport list. If you decline or location is unavailable, the flight platform opens without a prefilled departure airport. TravelGoGuide does not send or store your coordinates.", "Airport suggestions are generated in your browser from the site's scheduled-service airport list. You can enter a city, select a suggested airport, or type a three-letter airport code."] },
...
const privacyZhCN: LegalDocument = {
  ...
  sections: [
    ...
    { heading: "2. 地点输入", paragraphs: ["当你在文章页点击“订机票”时，网站会请求浏览器的精确位置权限，只用于从本站定期航班机场列表中选择附近的出发机场。若你拒绝或位置不可用，机票平台会在未预填出发机场的状态下打开。TravelGoGuide 不会发送或保存你的坐标。", "机场建议由浏览器根据网站内的定期航班机场列表生成。你可以输入城市、选择建议机场，或直接输入三字机场代码。"] },
