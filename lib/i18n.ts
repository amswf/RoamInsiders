...
const en: Copy = {
  ...
  aboutLead: "Roam Insider connects useful editorial content with the moment you are ready to act.",
...
export const copy: Record<Locale, Copy> = {
  "zh-CN": {
    ...
    aboutLead: "Roam Insider 把有用的旅行内容，和你准备行动的那一刻连在一起。",
  ...
  "zh-TW": {
    ...
    aboutTitle: "好的旅行建議，應該減少猶豫，而不是增加分頁。", aboutLead: "Roam Insider 把有用內容和行動連在一起。",
  ...
  id: {
    ...
    aboutLead: "Roam Insider menghubungkan konten berguna dengan saat Anda siap bertindak.", aboutBody: "Kami menjelaskan rute, promo, dan batasannya, lalu memberi satu tautan pemesanan yang jelas.", language: "Bahasa",
  },
