...
type Copy = {
  ...
  sources: string; verifiedOn: string; brandTagline: string;
};
...
const en: Copy = {
  ...
  language: "Language", sources: "Sources", verifiedOn: "Facts checked", brandTagline: "The world is big. Let's explore it together.",
};
...
export const copy: Record<Locale, Copy> = {
  "zh-CN": {
    ...
    language: "语言", sources: "资料来源", verifiedOn: "信息核验", brandTagline: "世界这么大，带你转一转。",
  },
  "zh-TW": {
    ...
    aboutBody: "我們說清路線、優惠與限制，再提供一個前往預訂平台的明確入口。", language: "語言", sources: "資料來源", verifiedOn: "資訊核驗", brandTagline: "世界這麼大，帶你轉一轉。",
  },
  en,
  id: {
    ...
    aboutLead: "TravelGoGuide menghubungkan konten berguna dengan saat Anda siap bertindak.", aboutBody: "Kami menjelaskan rute, promo, dan batasannya, lalu memberi satu tautan pemesanan yang jelas.", language: "Bahasa", sources: "Sumber", verifiedOn: "Fakta diperiksa", brandTagline: "Dunia begitu luas. Mari menjelajahinya.",
  },
  th: { ...en, discover: "ค้นพบ", routes: "เส้นทาง", deals: "โปรโมชัน", about: "เกี่ยวกับ", admin: "จัดการเนื้อหา", all: "ทั้งหมด", route: "เส้นทาง", deal: "โปรโมชัน", coupon: "คูปอง", guide: "คู่มือ", read: "อ่านเรื่อง", language: "ภาษา", back: "กลับสู่ฟีด", openTrip: "ดูตัวเลือกบน Trip.com", openTraveloka: "ดูตัวเลือกบน Traveloka", brandTagline: "โลกกว้างนัก ไปเที่ยวด้วยกัน" },
  vi: { ...en, discover: "Khám phá", routes: "Lịch trình", deals: "Ưu đãi", about: "Giới thiệu", admin: "Quản lý nội dung", all: "Tất cả", route: "Lịch trình", deal: "Ưu đãi", coupon: "Mã giảm giá", guide: "Cẩm nang", read: "Đọc bài", language: "Ngôn ngữ", back: "Quay lại dòng nội dung", openTrip: "Xem lựa chọn trên Trip.com", openTraveloka: "Xem lựa chọn trên Traveloka", brandTagline: "Thế giới rộng lớn. Cùng đi khám phá nhé." },
  ms: { ...en, discover: "Teroka", routes: "Laluan", deals: "Tawaran", about: "Tentang", admin: "Studio kandungan", all: "Semua", route: "Laluan", deal: "Tawaran", coupon: "Kupon", guide: "Panduan", read: "Baca cerita", language: "Bahasa", back: "Kembali ke aliran", openTrip: "Lihat pilihan di Trip.com", openTraveloka: "Lihat pilihan di Traveloka", brandTagline: "Dunia ini luas. Jom menerokainya." },
  fil: { ...en, discover: "Tuklasin", routes: "Ruta", deals: "Deal", about: "Tungkol", admin: "Content studio", all: "Lahat", route: "Mga ruta", deal: "Mga deal", coupon: "Mga kupon", guide: "Gabay", read: "Basahin", language: "Wika", back: "Bumalik sa feed", openTrip: "Tingnan sa Trip.com", openTraveloka: "Tingnan sa Traveloka", brandTagline: "Malawak ang mundo. Libutin natin ito." },
  km: { ...en, discover: "ស្វែងរក", routes: "ផ្លូវធ្វើដំណើរ", deals: "ប្រូម៉ូសិន", about: "អំពី", admin: "គ្រប់គ្រងមាតិកា", all: "ទាំងអស់", route: "ផ្លូវធ្វើដំណើរ", deal: "ប្រូម៉ូសិន", coupon: "គូប៉ុង", guide: "មគ្គុទ្ទេសក៍", read: "អាន", language: "ភាសា", back: "ត្រឡប់ទៅមាតិកា", brandTagline: "ពិភពលោកធំណាស់។ តោះទៅស្វែងយល់ជាមួយគ្នា។" },
  lo: { ...en, discover: "ຄົ້ນພົບ", routes: "ເສັ້ນທາງ", deals: "ໂປຣໂມຊັນ", about: "ກ່ຽວກັບ", admin: "ຈັດການເນື້ອຫາ", all: "ທັງໝົດ", route: "ເສັ້ນທາງ", deal: "ໂປຣໂມຊັນ", coupon: "ຄູປອງ", guide: "ຄູ່ມື", read: "ອ່ານ", language: "ພາສາ", back: "ກັບໄປຫາເນື້ອຫາ", brandTagline: "ໂລກກວ້າງໃຫຍ່. ໄປທ່ຽວນຳກັນ." },
  my: { ...en, discover: "ရှာဖွေမည်", routes: "ခရီးစဉ်များ", deals: "အထူးအစီအစဉ်", about: "အကြောင်း", admin: "အကြောင်းအရာစီမံရန်", all: "အားလုံး", route: "ခရီးစဉ်", deal: "အထူးအစီအစဉ်", coupon: "ကူပွန်", guide: "လမ်းညွှန်", read: "ဖတ်ရန်", language: "ဘာသာစကား", back: "အကြောင်းအရာသို့ ပြန်သွားရန်", brandTagline: "ကမ္ဘာကြီးက ကျယ်တယ်။ အတူလှည့်လည်ကြမယ်။" },
};
